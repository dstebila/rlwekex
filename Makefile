...
PRNG_CCFLAGS=-I/usr/local/opt/openssl/include #-DCONSTANT_TIME for constant time
...
all:
	...
	$(CC) $(CCFLAGS) -o rlwe_test -lcrypto rlwe_test.c fft.o rlwe_kex.o rlwe_rand.o $(LDFLAGS)
